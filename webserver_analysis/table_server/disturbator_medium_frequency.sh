...
INTERVAL_NS=100000000    # Intervallo tra le richieste in nanosecondi (10 richieste/secondo)
...
echo "Sending requests to port $PORT_DISTURBATOR with table size $TABLE_SIZE at 1,000 requests per second (interval $INTERVAL_NS ns)..."
while true; do

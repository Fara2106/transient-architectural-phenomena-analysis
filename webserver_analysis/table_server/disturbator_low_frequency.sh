...
INTERVAL_NS=1000000000    # Intervallo tra le richieste in nanosecondi (1 richieste/secondo)
...
echo "Sending requests to port $PORT_DISTURBATOR with table size $TABLE_SIZE at 10 requests per second (interval $INTERVAL_NS ns)..."
while true; do

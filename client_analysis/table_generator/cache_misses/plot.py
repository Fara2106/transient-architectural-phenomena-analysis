...
input_dir = "./perf_results_table_cache_misses"
...
axs[0].set_title("L1 Cache Misses per Table Size")
...
axs[1].set_title("L2 Cache Misses per Table Size")
...
axs[2].set_title("L3 Cache Misses per Table Size")
...
plt.tight_layout()
plt.savefig("cache_misses_per_table_size.png")
plt.show()